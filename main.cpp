...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "snode-seeder\n"
...
static const string mainnet_seeds[] = {"seed.snode.co", ""};
static const string testnet_seeds[] = {"seed.snode.co", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("51.15.91.74", 18988), true); //one of the seednode in chainparamsseeds.h
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.fUseTestNet) {
      ...
      pchMessageStart[0] = 0x6e; // This is Snode pchMessages for Testnet
